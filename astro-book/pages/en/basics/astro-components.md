...
[Astro syntax reference](/en/reference/astro-syntax/).
...
[built-in TypeScript support](/en/guides/typescript/).
...
[UI framework components](/en/guides/framework-components/)in your Astro project.
