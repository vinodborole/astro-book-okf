...
1. 
Install the [`@astrojs/mdx`](/en/guides/integrations-guide/mdx/) integration.
2. 
...
2. 
Create a `postcss.config.cjs` file at the root of your project with:For more information, read the [Tailwind CSS documentation](https://tailwindcss.com/docs/installation#add-tailwind-as-a-post-css-plugin)
